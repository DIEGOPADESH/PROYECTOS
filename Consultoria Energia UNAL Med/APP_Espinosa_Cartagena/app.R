...
ui <- dashboardPage(
  ...
  "))
    ...
    tabItem(tabName = "tab_graficos",
            ...
            br(),
            fluidRow(
              column(6, # Esta columna ocupará el 50% del ancho (6 de 12 unidades)
                     h3(strong("Límites de armónicos permitidos en un sistema eléctrico - Norma IEEE 519")),
                     br(),
                     br(),
                     tags$image(src = "norma IEEE 519.jpg", height = "350px", width = "600px", style = "display: block; margin-left: auto; margin-right: auto;"),
                     h4("")
              ),
              column(6, # Esta columna también ocupará el 50% del ancho
                     h3(strong("Límites de armónicos permitidos en un sistema eléctrico - Norma NTC 5001")),
                     br(),
                     br(),
                     tags$image(src = "norma NTC 5001.jpg", height = "350px", width = "600px", style = "display: block; margin-left: auto; margin-right: auto;"),
                     h4("")
              )
            ),
            br(),
...
server <- function(input, output) {
  ...
  # Para mostrar edificaciones en las que se hará el análisis:
  output$edif <- renderValueBox({
    valueBox(
      "Edificación:",
      HTML(paste0("<p style='font-size: 150%;'>Se analizarán los bloques:<br>", paste(unique(datasetor()[,9]),collapse = ", "),"</p>")),
      icon = icon("building"),
      color = "light-blue"
    )
  })
  
  # Para mostrar fecha de inicio de registros de la base de datos
  output$inicio_reg <- renderValueBox({
    valueBox(
      "Inicio:",
      HTML(paste0("<p style='font-size: 150%;'>La base de datos contiene registros desde:<br>", aviso(debugging_BD(datos())[[2]]),"</p>")),
      icon = icon("calendar-minus"),
      color = "light-blue"
    )
  })
  
  # Para mostrar fecha de fin de registros de la base de datos
  output$fin_reg <- renderValueBox({
    valueBox(
      "Fin:",
      HTML(paste0("<p style='font-size: 150%;'>La base de datos contiene registros hasta:<br>",aviso(debugging_BD(datos())[[3]]),"</p>")),
  ...
  output$bloque_box <- renderValueBox({
    valueBox(
      "Edificación:",
      HTML(paste0("<p style='font-size: 150%;'>",unique(datasetor()[,9]),collapse = ", "),"</p>"),
      icon = icon("building"),
      color = "light-blue"
    )
  })
  ...
  output$fecha1_box <- renderValueBox({
    valueBox(
      "Fecha inicial:",
      HTML(paste0("<p style='font-size: 150%;'>El análisis se realiza desde ", format(as.Date(aviso(as.character(input$fecha1_id))),"%d/%m/%Y"),"</p>")),
      icon = icon("calendar-minus"),
      color = "light-blue"
    )
  })
  ...
  output$fecha2_box <- renderValueBox({
    valueBox(
      "Fecha final:",
      HTML(paste0("<p style='font-size: 150%;'>El análisis se realiza hasta ", format(as.Date(aviso(as.character(input$fecha2_id))),"%d/%m/%Y"),"</p>")),
      icon = icon("calendar-plus"),
      color = "light-blue"
    )
  })
  ...
  output$bloque_box2 <- renderValueBox({
    valueBox(
      "Edificación:",
      HTML(paste0("<p style='font-size: 150%;'>", paste(unique(datasetor()[,9]), collapse = ", "),"</p>")),
      icon = icon("building"),
      color = "light-blue"
    )
  })
  ...
  output$fecha1_box3 <- renderValueBox({
    valueBox(
      "Fecha inicial:",
      HTML(paste0("<p style='font-size: 150%;'>El análisis se realiza desde ", format(as.Date(aviso(as.character(input$fecha1_id))),"%B %d de %Y"),"</p>")),
      icon = icon("calendar-minus"),
      color = "light-blue"
    )
  })
  ...
  output$fecha2_box3 <- renderValueBox({
    valueBox(
      "Fecha final:",
      HTML(paste0("<p style='font-size: 150%;'>El análisis se realiza hasta ", format(as.Date(aviso(as.character(input$fecha2_id))),"%B %d de %Y"),"</p>")),
      icon = icon("calendar-plus"),
      color = "light-blue"
    )
  })
  ...
  output$bl_box <- renderValueBox({
    valueBox(
      "Edificación:",
      HTML(paste0("<p style='font-size: 150%;'>", paste(unique(datasetor1()[,11]), collapse = ", "),"</p>")),
      icon = icon("building"),
      color = "light-blue"
    )
  })
  ...
  output$date1_box <- renderValueBox({
    valueBox(
      "Fecha inicial:",
      HTML(paste0("<p style='font-size: 150%;'>El análisis se realiza desde ", format(as.Date(aviso(as.character(input$date1_id))),"%d/%m/%Y"),"</p>")),
      icon = icon("calendar-minus"),
      color = "light-blue"
    )
  })
  ...
  output$date2_box <- renderValueBox({
    valueBox(
      "Fecha final:",
      HTML(paste0("<p style='font-size: 150%;'>El análisis se realiza hasta ", format(as.Date(aviso(as.character(input$date2_id))),"%d/%m/%Y"),"</p>")),
      icon = icon("calendar-plus"),
      color = "light-blue"
    )
  })
  ...
  output$voltage_debug_BL <- renderValueBox({
    ...
    valueBox(
      "Edificaciones:",
      HTML(paste0("<p style='font-size: 200%;'>", paste(bloques_unicos, collapse = ", "),"</p>")),
      icon = icon("building"),
      color = "light-blue"
    )
  })
  ...
  output$voltage_debug_inicio <- renderValueBox({
    ...
    valueBox(
      "Fecha de inicio:",
      HTML(paste0("<p style='font-size: 200%;'>", format(fecha_minima, "%Y-%m-%d %H:%M:%S"),"</p>")),
  ...
  output$voltage_debug_fin <- renderValueBox({
    ...
    valueBox(
      "Fecha de fin:",
      HTML(paste0("<p style='font-size: 200%;'>", format(fecha_maxima, "%Y-%m-%d %H:%M:%S"),"</p>")),
