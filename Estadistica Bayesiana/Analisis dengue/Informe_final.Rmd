...
\title{Clasificación de pacientes con presencia de Dengue, desde un enfoque bayesiano}
...
tabla <- data.frame(
  ...
  Tipo = c("number","factor","number","factor","factor","factor","factor","factor","factor","factor","factor","factor","factor","factor","factor","factor","factor","factor","factor","factor","factor","factor","factor","factor","factor","factor","factor","factor","factor","factor","factor","factor","factor","factor","factor","factor","factor","factor"
))
...
Nombre = c("clas_dengue","fiebre","cefalea","dolrretroo","malgias","artralgia","erupcionr","dolor_abdo","vomito","somnolenci","hipotensio","hepatomeg","hem_mucosa","hipotermia","aum_hemato","caida_plaq","acum_liquievento"),
 ...
 Tipo = c("factor","factor","factor","factor","factor","factor","factor","factor","factor","factor","factor","factor","factor","factor","factor","factor","factor"))
